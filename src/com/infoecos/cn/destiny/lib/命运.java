...
public class 命运 {
    ...
    public static Date 起运交脱(Date birthday, boolean isMale,
                            TimezoneLocation location) throws Exception {
        boolean isForward = 顺行(birthday, isMale, location);
    ...
    public static 干支[] 大运(Date birthday, boolean isMale, TimezoneLocation location)
            throws Exception {
        boolean isForward = 顺行(birthday, isMale, location);
    ...
    public static 干支 大运(Date birthday, boolean isMale, TimezoneLocation location,
        ...
        int days = (int) ((now.getTime() - 起运交脱(birthday, isMale, location)
    ...
    @SuppressWarnings("deprecation")
    public static int 大运经年(Date birthday, boolean isMale,
    ...
    @SuppressWarnings("deprecation")
    public static 干支 小运(Date birthday, boolean isMale, TimezoneLocation location,
                        Date now) throws Exception {
