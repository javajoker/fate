...
public enum 五行 {
    ...
    private String[] 人事; // [盛者人事, 过盛人事, 衰者人事, 死绝人事]
    private String[] 外貌; // [盛者外貌, 衰者外貌]
    private String 方位;
    private String 职业;

    public String 外貌(boolean strong) {
        return strong ? 外貌[0] : 外貌[1];
    }

    public String 人事(boolean strong) {
        return strong ?
                (!"".equals(人事[1]) ?
                        String.format("%s但须注意%s", 人事[0], 人事[1])
                        : 人事[0])
                : 人事[2];
    }
